...
**DiGi.SQLite** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.SQLite](DiGi.SQLite)** (Path: `DiGi.SQLite\DiGi.SQLite`)
